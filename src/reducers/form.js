import { formActionTypesForScope } from '../../actions/helpers/form-actions';
import { validateObjectLiteral, validateFieldAndBuildState } from '../../utils/validation';
        ...
        switch (action.type) {
            case actionTypes.FORM_INPUT_CHANGED:
                ...
                return {
                    ...state,
                    item,
                    validations: validateFieldAndBuildState(item, state.validations,
                        action.field, validationsSpec[action.field])
                }
            case actionTypes.FORM_VALIDATE_FIELD:
                return {
                    ...state,
                    validations: validateFieldAndBuildState(state.item, state.validations,
                        action.field, validationsSpec[action.field])
                }
